    ...
    public void NewInventory(Player player, Inventype inventype, OfflinePlayer target)
    {
        ...
        if (inventype.equals(Inventype.Island))
        {
            ...
            else
            {
                ...
                if (player.hasPermission("skylyfe.is.settings"))
                {
                ...
                if (player.hasPermission("skylyfe.is.level"))
                {
        ...
        else if (inventype.equals(Inventype.Team))
        {
            ...
            {
                if (player.hasPermission("skylyfe.is.listmembers"))
                {
                    int rank = 0;
        ...
        else if (inventype.equals(Inventype.GUI))
        {
            ...
            description.add(ChatColor.translateAlternateColorCodes('&', "&7statistics on SkyLyfe!"));
            description.add("");
