 ...
 */
public class SkyLyfePlaceholder extends PlaceholderExpansion {

    // We get an instance of the plugin later.
    private SkyLyfeMain plugin;
    ...
    public boolean canRegister(){
        return (plugin = (SkyLyfeMain) Bukkit.getPluginManager().getPlugin(getRequiredPlugin())) != null;
    }
