    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)
    {
        if (cmd.getName().equalsIgnoreCase(cmds[0]))
        {
            if (sender instanceof Player)
            {
                ...
                if (args.length == 0)
                {
                    ...
                    {
                        if(sender.hasPermission("skyblock.is.create"))
                        {
                    ...
                    if(sender.hasPermission("skyblock.is.home"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.help"))
                ...
                {
                    if(sender.hasPermission("skyblock.is.gui"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.delete"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.biome"))
                    {
                        if (args.length == 1)
                        {
                ...
                {
                    if(sender.hasPermission("skyblock.is.level"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.top"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.sethome"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.fixhome"))
                    {
                        //Sets the players islands home if he is owner
                ...
                {
                    if(sender.hasPermission("skyblock.is.name"))
                    {
                        if (args.length == 1)
                ...
                {
                    if(sender.hasPermission("skyblock.is.value"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.team"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.leave"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.makeleader"))
                    {
                        if (args.length == 1)
                ...
                {
                    if(sender.hasPermission("skyblock.is.teamchat"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.suspend"))
                    {
                        if (args.length == 1)
                ...
                {
                    if(sender.hasPermission("skyblock.is.ban"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.unban"))
                    {
                        if (args.length == 1)
                            sender.sendMessage(ChatColor.GOLD + "Usage: /is suspend [Player]");
                        else
                ...
                {
                    if(sender.hasPermission("skyblock.is.banlist"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.invite"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.kick"))
                    {
                        if (args.length == 1)
                        {
                ...
                {
                    if(sender.hasPermission("skyblock.is.listmembers"))
                    {
                ...
                if (args[0].equalsIgnoreCase("coop"))
                {
                    ...
                    {
                        if(sender.hasPermission("skyblock.is.coop"))
                        {
                            //adds another player to the players island team
                            Player cooped = main.getServer().getPlayer(args[1]);
                            if (cooped != null)
                ...
                {
                    if(sender.hasPermission("skyblock.is.uncoop"))
                    {
                        if (args.length == 1)
                        {
                ...
                {
                    if(sender.hasPermission("skyblock.is.listcoops"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.lock"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.unlock"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.resetname"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.settings"))
                    {
                        if (islandManager.GetIsland(player) == null)
                        {
                ...
                {
                    if(sender.hasPermission("skyblock.is.accept"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.reject"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.is.challenges"))
                    {
                ...
                {
                    if (sender.hasPermission("skyblock.is.rank"))
                    {
                ...
                {
                    if (sender.hasPermission("skyblock.is.rankup"))
                    {
        ...
        if (cmd.getName().equalsIgnoreCase(cmds[1]))
        {
            if (sender instanceof Player)
            {
                ...
                {
                    if (sender.hasPermission("skyblock.admin.remove"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.admin.wand"))
                    {
                ...
                if (args[0].equalsIgnoreCase("schematic"))
                {
                    ...
                    if(sender.hasPermission("skyblock.admin.schematic"))
                    {
                ...
                {
                    if(sender.hasPermission("skyblock.admin.spy"))
                    {
        ...
        if (cmd.getName().equalsIgnoreCase(cmds[3]))
        {
            ...
            {
                Player player = (Player) sender;
                if (player.hasPermission("skyblock.admin.toggleog") && args.length != 0)
                {
