...
public class SkyblockMain extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        {
            SkyblockPlaceholder skyblockPlaceholder = new SkyblockPlaceholder();
            skyblockPlaceholder.register();
        }
        ...
        getLogger().log(Level.INFO, ChatColor.GREEN + "Succesfully loaded skyblock");
    ...
    private void LoadSavedSchematic()
    {
        ...
        {
            getServer().broadcastMessage(ChatColor.RED + "[skyblock] Failed to load schematic");
        }
    }
    void SaveSkullMeta()
    {
    ...
    void InitializePrefixes() {
        prefixes.add(new Prefix("mmoskyblock.prefix.default", ChatColor.translateAlternateColorCodes('&', "&8[&7lvl. €&8]&r $&8[&7OG&8]$&r &8[&7Islander&8] &r&7%1s&0: &7%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.skymage", ChatColor.translateAlternateColorCodes('&', "&0[&2lvl. €&0]&r $&0[&2OG&0]$&r &2&kii&0[&2SkyMage&0]&2&kii &r&2%1s&0: &2%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.skywizard", ChatColor.translateAlternateColorCodes('&', "&0[&9lvl. €&0]&r $&0[&9OG&0]$&r &9&kii&0[&9SkyWizard&0]&9&kii &r&9%1s&0: &9%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.skymaster", ChatColor.translateAlternateColorCodes('&', "&0[&dlvl. €&0]&r $&0[&dOG&0]$&r &d&kii&0[&dSkyMaster&0]&d&kii &r&d%1s&0: &d%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.skylord", ChatColor.translateAlternateColorCodes('&', "&0[&alvl. €&0]&r $&0[&aOG&0]$&r &a&kii&0[&aSkyLord&0]&a&kii &r&a%1s&0: &a%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.skylegend", ChatColor.translateAlternateColorCodes('&', "&0[&3lvl. €&0]&r $&0[&3OG&0]$&r &3&kii&0[&3SkyLegend&0]&3&kii &r&3%1s&0: &3%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.skyimmortal", ChatColor.translateAlternateColorCodes('&', "&0[&4lvl. €&0]&r $&0[&4OG&0]$&r &4&kii&0[&4SkyImmortal&0]&4&kii &r&4%1s&0: &4%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.skygod", ChatColor.translateAlternateColorCodes('&', "&0[&blvl. €&0]&r $&0[&bOG&0]$&r &b&kii&0[&bSkyGod&0]&b&kii &r&b%1s&0: &b%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.helper", ChatColor.translateAlternateColorCodes('&', "&0[&elvl. €&0]&r $&0[&eOG&0]$&r &e&kii&0[&eHelper&0]&e&kii &r&e%1s&0: &e%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.mod", ChatColor.translateAlternateColorCodes('&', "&0[&2lvl. €&0]&r $&0[&2OG&0]$&r &2&kii&0[&2Mod&0]&2&kii &r&2%1s&0: &2%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.headmod", ChatColor.translateAlternateColorCodes('&', "&0[&alvl. €&0]&r $&0[&aOG&0]$&r &a&kii&0[&aHead-Mod&0]&a&kii &r&a%1s&0: &a%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.subadmin", ChatColor.translateAlternateColorCodes('&', "&0[&clvl. €&0]&r $&0[&cOG&0]$&r &c&kii&0[&cSub-Admin&0]&c&kii &r&c%1s&0: &c%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.admin", ChatColor.translateAlternateColorCodes('&', "&0[&4lvl. €&0]&r $&0[&4OG&0]$&r &4&kii&0[&4Admin&0]&4&kii &r&4%1s&0: &4%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.lazydefault", ChatColor.translateAlternateColorCodes('&', "&0[&blvl. €&0]&r $&0[&bOG&0]$&r &8[&7LazyDefault&8] &r&b%1s&0: &b%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.gizmo", ChatColor.translateAlternateColorCodes('&', "&0[&blvl. €&0]&r $&0[&bOG&0]$&r &0&l[&8&lG&7&liz&f&lmo&0&l] &r&b%1s&0: &b%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.rosie", ChatColor.translateAlternateColorCodes('&', "&0[&blvl. €&0]&r $&0[&bOG&0]$&r &0&l[&4&lR&d&lo&a&ls&b&li&e&le&c&l<3&0&l] &r&b%1s&0: &b%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.owner", ChatColor.translateAlternateColorCodes('&', "&0[&blvl. €&0]&r $&0[&bOG&0]$&r &b&kii&0[&bOwner&0]&b&kii &r&b%1s&0: &b%2s")));
        prefixes.add(new Prefix("mmoskyblock.prefix.mahshadow", ChatColor.translateAlternateColorCodes('&', "&0[&blvl. €&0]&r $&0[&bOG&0]$&r &b&kii&f&l[&8&lCh&7&lha&f&lya&f&l]&b&kii&r &b%1s&0: &b%2s")));
    }
}
